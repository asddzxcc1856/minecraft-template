        ...
        <>
            ...
            <div className="container-fluid h-auto text-center text-wrap bg-opacity-75 bg-light bg-gradient" data-aos="fade-left">
                ...
                <div className="fs-5 row row-cols-1 row-cols-sm-2 row-cols-xl-4">
                    <div className="col pt-5 pb-5 fw-bolder fs-4 text-start">
                        <img src={require("./diamond.jpg")} className="d-block w-25 rounded mx-auto shadow-2-strong" alt="..." />
                        VIP
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>領地數量3個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>家數量5個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                    </div>
                    <div className="col pt-5 pb-5 fw-bolder fs-4 text-start">
                        ...
                        VIP+
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>領地數量5個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>家數量7個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                    </div>
                    <div className="col pt-5 pb-5 fw-bolder fs-4 text-start">
                        ...
                        VIP++
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>領地數量7個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>家數量9個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                    </div>
                    <div className="col pt-5 pb-5 fw-bolder fs-4 text-start">
                        ...
                        VIP+++
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>領地數量9個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i>家數量11個</p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                        <p className="fs-5"><i class="bi bi-chevron-right"></i></p>
                    </div>
